...
<template>
    <div class="uiLoadingSpinner"></div>
</template>
...
@keyframes ui-loading-spinner-spin {
    ...
    25% {
        ...
        background-color: v-bind("$props.color2 ?? 'var(--color-2)'");
        box-shadow: 0px 0px 8px v-bind("$props.color2 ?? 'var(--color-2)'");
    }
    ...
    75% {
        ...
        box-shadow: 0px 0px 8px v-bind("$props.color1 ?? 'var(--color-1)'");
    }
